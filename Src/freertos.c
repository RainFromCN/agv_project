...
osThreadId spdmHandle;
osThreadId kalmanHandle;
osThreadId pospidHandle;
...
extern void spdm_thread(void const * argument);
extern void kalman_thread(void const * argument);
extern void pospid_calc_thread(void const * argument);
extern void imu_thread(void const * argument);
extern void arm_calc_thread(void const * argument);
